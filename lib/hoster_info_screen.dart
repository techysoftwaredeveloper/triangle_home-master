...
class _HosterInfoScreenState extends State<HosterInfoScreen> {
  ...
  // Preferences
  final List<String> _preferredTenants = ['Students'];
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _buildStatusDashboard(completion)
                              .animate()
  ...
  Widget _buildVerifIndicator(
    ...
    final Color color =
        isDone
            ? Colors.green
            : (isPending ? Colors.orange : Colors.grey[400] ?? Colors.grey);
    return Column(
      children: [
        Container(
          ...
          child: Icon(
            isDone
                ? Icons.check_circle
                : (isPending ? Icons.pending : Icons.circle_outlined),
            size: 18,
            color: color,
          ),
        ),
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 4),
                    const Text(
                      'A clear photo builds trust with tenants.',
                      style: TextStyle(
                        fontSize: 12,
                        color: AppTheme.textLightColor,
                        fontFamily: 'Outfit',
          ...
          children: [
            Container(
              ...
              child: Image.network(
                ...
                errorBuilder:
                    (_, __, ___) =>
                        const Icon(Icons.badge, size: 24, color: Colors.grey),
              ),
            ),
            const SizedBox(width: 16),
            Expanded(
