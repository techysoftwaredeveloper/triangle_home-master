    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text('GENDER PREFERENCE', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: AppTheme.textMutedColor, letterSpacing: 1.0)),
          ...
          const Text('ROOM CATEGORY', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: AppTheme.textMutedColor, letterSpacing: 1.0)),
          const SizedBox(height: 12),
          CustomToggleButtons(
