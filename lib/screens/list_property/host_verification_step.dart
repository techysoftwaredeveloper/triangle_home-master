...
class HostVerificationStep extends StatefulWidget {
  ...
  const HostVerificationStep({super.key, required this.onContinue, this.initialData});
...
class _HostVerificationStepState extends State<HostVerificationStep> {
  ...
  void initState() {
    super.initState();
    if (widget.initialData != null && widget.initialData!['verification'] != null) {
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(color: AppTheme.successColor.withOpacity(0.1)),
            ),
            child: Row(
              children: [
                Container(
                  ...
                  child: Column(
                    ...
                    children: const [
                      Text(
                        ...
                        style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: AppTheme.textDarkColor, fontFamily: 'Outfit'),
                      ),
                      SizedBox(height: 4),
                      Text(
                        'You can add more documents later',
                        style: TextStyle(fontSize: 10, color: AppTheme.textLightColor, fontFamily: 'Outfit'),
                      ),
                    ],
                  ),
                ),
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              onPressed: (_aadhaarUrl != null && _panUrl != null) 
                ? () {
                    widget.onContinue({
                      'verification': {
              ...
              child: const Text('Continue', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 16, fontFamily: 'Outfit')),
            ),
          ),
        ],
      ),
