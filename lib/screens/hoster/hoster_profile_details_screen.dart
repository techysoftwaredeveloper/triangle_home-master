          ...
          _buildSectionHeader(
            ...
            onAction: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (_) => const HosterTrustScoreScreen(),
                ),
              );
            },
          ),
            ...
            child: Stack(
              ...
              children: [
                SizedBox(
                  width: 120,
                  height: 60,
                  child: CustomPaint(painter: HalfGaugePainter(score: 0.91)),
                ),
                Positioned(
                  bottom: 0,
                  child: Column(
        ...
        children: [
          _buildSectionHeader(
            ...
            onAction: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (_) => const HosterReviewsScreen()),
              );
            },
          ),
          _buildReviewItem(
        ...
        children: [
          _buildSectionHeader(
            ...
            onAction: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (_) => const HosterIdentityScreen()),
              );
            },
          ),
          _buildDocRow(
