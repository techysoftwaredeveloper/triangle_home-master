...
class _OwnerProfileEditScreenState extends State<OwnerProfileEditScreen> {
  ...
  Future<void> _saveProfile() async {
    ...
    try {
      ...
      if (mounted) {
        Fluttertoast.showToast(msg: 'Profile updated successfully!', backgroundColor: AppTheme.successColor);
          ...
          Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 12),
                _buildVerifMiniRow('Email Verified', _userData?['status'] == 'approved'),
                const SizedBox(height: 8),
    ...
    return Row(
      children: [
        Icon(
          ...
          size: 16,
          color: isDone ? Colors.green : (isPending ? Colors.orange : Colors.grey),
        ),
                  ...
                  child: ClipOval(
                    child: _newImageFile != null
                        ...
                        : (_profileImageUrl != null
                            ...
                            : const Icon(Icons.person, size: 48, color: Color(0xFF4CAF50))),
                  ),
                ),
                Positioned(
                  bottom: 0,
  ...
  Widget _buildContactSection() {
    ...
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const Text('Contact Information', style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: AppTheme.textDarkColor)),
        const SizedBox(height: 16),
        _buildTextField('Phone Number *', _phoneController, Icons.phone_android_outlined, isVerified: true, readOnly: true),
        const SizedBox(height: 16),
        _buildTextField('Email Address *', _emailController, Icons.email_outlined, isVerified: user?.emailVerified ?? false, readOnly: true),
      ],
    );
  }
  ...
  Widget _buildAddressSection() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const Text('Address Information', style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: AppTheme.textDarkColor)),
        const SizedBox(height: 16),
        _buildTextField('Address Line 1 *', _address1Controller, Icons.location_on_outlined),
        const SizedBox(height: 16),
        _buildTextField('Address Line 2 (Optional)', _address2Controller, Icons.location_on_outlined),
        const SizedBox(height: 16),
        Row(
          children: [
            Expanded(child: _buildTextField('City *', _cityController, Icons.business_outlined)),
    ...
    return Column(
      children: [
            ...
            TextButton(
              ...
              child: const Row(
                children: [
                  ...
                  SizedBox(width: 4),
                  Icon(Icons.chevron_right, size: 14, color: AppTheme.successColor),
                ],
              ),
            ),
          ],
        ...
        _buildIdentityTile(
          ...
          verif['govIdVerified'] == true
              ? Colors.green
              : (verif['govIdStatus'] == 'pending' ? Colors.orange : Colors.grey),
          ...
          children: [
            ...
            Container(
              ...
              child: Row(
                children: [
                  Icon(
                    status == 'Verified' ? Icons.check_circle : Icons.access_time_filled,
                    size: 12,
                    color: color,
                  ),
                ...
                child: Column(
                  children: [
                    Container(
                      padding: const EdgeInsets.all(8),
                      decoration: BoxDecoration(
                        color: isSelected ? AppTheme.successColor.withOpacity(0.1) : Colors.grey[50],
                        shape: BoxShape.circle,
                      ),
                      child: Icon(
                        icons[i],
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            focusedBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(12),
              borderSide: const BorderSide(color: AppTheme.successColor, width: 1),
            ),
  ...
  Widget _buildDropdownField(String label, List<String> items, String? value, Function(String?) onChanged) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(label, style: const TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: AppTheme.textLightColor)),
        const SizedBox(height: 8),
        Container(
          ...
          child: DropdownButtonFormField<String>(
            isExpanded: true,
            value: value,
            items: items.map((s) => DropdownMenuItem(value: s, child: Text(s, style: const TextStyle(fontSize: 14, fontWeight: FontWeight.bold, fontFamily: 'Outfit')))).toList(),
            onChanged: onChanged,
          ...
          child: Container(
            ...
            child: Row(
              children: [
                ...
                const SizedBox(width: 12),
                Text(current != null ? DateFormat('dd MMM yyyy').format(current) : 'Select Date', style: const TextStyle(fontSize: 14, fontWeight: FontWeight.bold, fontFamily: 'Outfit')),
                const Spacer(),
