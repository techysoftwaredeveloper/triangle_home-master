            ...
            allBookings.where((b) {
              final matchesSearch =
                  (b['id']?.toString().toLowerCase().contains(_searchQuery) ??
                      false) ||
                  (b['guestName']?.toString().toLowerCase().contains(
                        _searchQuery,
                      ) ??
                      false) ||
                  (b['propertyName']?.toString().toLowerCase().contains(
                        _searchQuery,
                      ) ??
                      false);
              ...
              switch (_tabController.index) {
                ...
                case 4:
                  return matchesSearch && status == 'checked_out';
                default:
                  return matchesSearch;
              }
            }).toList();
    ...
    return SingleChildScrollView(
      ...
      child: Row(
        children: [
          ...
          const SizedBox(width: 16),
          _StatCard(
            count: format.format(totalRevenue),
            label: 'Total Revenue',
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    b['propertyName'] ?? 'Untitled Property',
                    style: const TextStyle(
                      fontSize: 20,
                      fontWeight: FontWeight.bold,
                      color: Color(0xFF0F172A),
                  ...
                  const SizedBox(height: 4),
                  Text(
                    b['propertyType']?.toString().toUpperCase() ??
                        'PG / HOSTEL',
                    style: const TextStyle(
                      fontSize: 11,
                      fontWeight: FontWeight.bold,
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              b['userRole']?.toString().toUpperCase() ??
                                  'STUDENT',
                              style: const TextStyle(
                                fontSize: 11,
                                fontWeight: FontWeight.bold,
                  ...
                  _sheetRow(
                    'Duration',
                    '${b['duration'] ?? 1} Month (${b['nights'] ?? 30} Nights)',
                  ),
                  ...
                  _sheetRow(
                    'Payment Method',
                    b['paymentMethod']?.toString().toUpperCase() ?? 'UPI',
                  ),
                  _sheetRow(
                    'Payment Status',
                    (b['paymentStatus'] ?? 'pending').toString().toUpperCase(),
                    valueColor:
                  ...
                  _sheetActionBtn(
                    ...
                    () => _handleBookingAction(b['id'], 'invoice'),
                  ),
                  const SizedBox(height: 12),
                  _sheetActionBtn(
                    'Send Message',
                    ...
                    () => _handleBookingAction(b['id'], 'message'),
                  ),
                  const SizedBox(height: 12),
                  _sheetActionBtn(
                    'Cancel Booking',
      ...
      child: Row(
        children: [
          Icon(
            ...
            size: 18,
            color:
                completed ? const Color(0xFF10B981) : const Color(0xFFCBD5E1),
          ),
          const SizedBox(width: 12),
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
...
class _BookingTableCard extends StatelessWidget {
          ...
          children: [
            Expanded(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    item['id']?.toString().toUpperCase() ?? 'N/A',
                    style: const TextStyle(
                      fontWeight: FontWeight.bold,
                      fontSize: 13,
                      color: Color(0xFF0F172A),
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          item['propertyType']?.toString() ?? 'N/A',
                          style: const TextStyle(
                            fontSize: 10,
                            fontWeight: FontWeight.bold,
                            color: Color(0xFF94A3B8),
            ...
            Expanded(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    '${_formatDateShort(item['checkIn'])} - ${_formatDateShort(item['checkOut'])}',
                    style: const TextStyle(
                      fontSize: 11,
                      color: Color(0xFF64748B),
                    ),
            ...
            Expanded(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    amountFormat.format(item['price'] ?? 6500),
                    style: const TextStyle(
                      fontWeight: FontWeight.bold,
                      fontSize: 14,
                      color: Color(0xFF0F172A),
                  ...
                  Text(
                    (item['paymentStatus'] ?? 'paid').toString().toUpperCase(),
                    style: TextStyle(
                      fontSize: 10,
                      fontWeight: FontWeight.bold,
                      color:
  ...
  String _formatDateShort(dynamic date) {
    if (date == null) return 'N/A';
    if (date is Timestamp) return DateFormat('dd MMM').format(date.toDate());
    return date.toString();
  }
...
class _StatusPill extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Color color;
    final Color bg;
    if (s == 'confirmed' || s == 'checked_out') {
      label = s == 'confirmed' ? 'Confirmed' : 'Checked Out';
      color = const Color(0xFF10B981);
