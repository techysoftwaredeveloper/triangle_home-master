...
class _LocalitySearchPopupState extends State<LocalitySearchPopup> {
  ...
  Widget build(BuildContext context) {
    final filteredLocalities = widget.localities
          ...
          children: [
            ...
            Expanded(
              child: ListView.builder(
                ...
                padding: const EdgeInsets.symmetric(horizontal: 24),
                itemCount: filteredLocalities.isEmpty ? 1 : filteredLocalities.length,
                itemBuilder: (context, index) {
                  ...
                  final isSelected = widget.selectedLocalities.contains(locality);
                      ...
                      child: Row(
                        children: [
                          ...
                          if (isSelected)
                            ...
                            const Icon(Icons.add_circle_outline_rounded, color: Color(0xFFCBD5E1), size: 20),
                        ],
                      ),
                    ),
                  );
