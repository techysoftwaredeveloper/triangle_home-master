...
class _CollegeSearchPopupState extends State<CollegeSearchPopup> {
  ...
  Widget build(BuildContext context) {
    final filteredColleges = widget.colleges
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: TextField(
                      ...
                      autofocus: false, // Wait for manual click to show keyboard
                      style: const TextStyle(fontFamily: 'Outfit', fontSize: 14),
                      decoration: const InputDecoration(
                        hintText: 'Search for College Name',
                        hintStyle: TextStyle(color: Color(0xFF94A3B8), fontSize: 14),
                        suffixIcon: Icon(Icons.search_rounded, color: Color(0xFF94A3B8), size: 24),
                  ...
                  if (_searchQuery.isNotEmpty) ...[
                    ...
                    if (filteredColleges.isEmpty)
                      ...
                      ...filteredColleges.map((college) => _buildResultItem(college)),
                  ],
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            const Icon(Icons.north_east_rounded, color: Color(0xFF94A3B8), size: 18),
          ],
        ),
      ),
    );
