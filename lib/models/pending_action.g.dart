...
PendingAction _pendingActionDeserialize(
  ...
  final object = PendingAction(
    actionId: reader.readString(offsets[0]),
    createdAt: reader.readDateTime(offsets[1]),
    payload: reader.readString(offsets[2]),
    retryCount: reader.readLongOrNull(offsets[3]) ?? 0,
...
extension PendingActionQuerySortBy
  ...
  QueryBuilder<PendingAction, PendingAction, QAfterSortBy> sortByActionId() {
    return QueryBuilder.apply(this, (query) {
...
extension PendingActionQuerySortThenBy
  ...
  QueryBuilder<PendingAction, PendingAction, QAfterSortBy> thenByActionId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'actionId', Sort.asc);
    });
  }
...
extension PendingActionQueryWhereDistinct
  ...
  QueryBuilder<PendingAction, PendingAction, QDistinct> distinctByActionId(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension PendingActionQueryProperty
  ...
  QueryBuilder<PendingAction, String, QQueryOperations> actionIdProperty() {
    return QueryBuilder.apply(this, (query) {
